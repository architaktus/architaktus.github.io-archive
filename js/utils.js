...
NexT.utils = {
  ...
  registerScrollPercent: function() {
    ...
    window.addEventListener('scroll', () => {  
        ...
        //滚动比例＞10% 则显示
        backToTop.classList.toggle('back-to-top-on', Math.round(scrollPercent) >= 10);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  activateNavByIndex: function(index) {
    ...
    const tocElement = document.querySelector(CONFIG.scheme === 'Pisces' || CONFIG.scheme === 'Gemini' ? '.post-toc-wrapper' : '.sidebar');
  ...
  activateSidebarPanel: function(index) {
    const sidebar = document.querySelector('.sidebar-menu__list');
